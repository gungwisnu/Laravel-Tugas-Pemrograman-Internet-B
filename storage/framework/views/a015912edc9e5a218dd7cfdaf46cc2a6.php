    ...
    <div class="mb-6">
      <table class="w-full text-left border border-gray-200 rounded-md">
        <tr>
          ...
          <td class="p-2 border-b"><?php echo e($mahasiswa->id); ?></td>
        </tr>
        <tr>
          <th class="p-2 bg-gray-50 border-b">NIM</th>
          <td class="p-2 border-b"><?php echo e($mahasiswa->nim); ?></td>
        </tr>
        <tr>
          <th class="p-2 bg-gray-50 border-b">Nama</th>
          <td class="p-2 border-b"><?php echo e($mahasiswa->nama); ?></td>
        </tr>
        <tr>
          <th class="p-2 bg-gray-50">Prodi</th>
          <td class="p-2"><?php echo e($mahasiswa->prodi); ?></td>
        </tr>
      </table>
    </div>

    <form method="POST" action="<?php echo e(route('mahasiswa.destroy', $mahasiswa->id)); ?>" class="flex justify-center gap-4">
      <?php echo csrf_field(); ?>
...
<?php /**PATH C:\projectlaravel\kampus-laravel\resources\views/mahasiswa/delete.blade.php ENDPATH**/ ?>